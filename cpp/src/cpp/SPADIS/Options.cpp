...
bool spadis::Options::isInMeasurementMode() const
{
	return isInDeltaMeasurementMode() || isInBetaMeasurementMode();
}

bool spadis::Options::isInDeltaMeasurementMode() const
{
	return deltaMeasurementModeFlag_;
}

bool spadis::Options::isInBetaMeasurementMode() const
{
	return betaMeasurementModeFlag_;
}
...
void spadis::Options::setBetaMeasurementMode(bool b)
{
	betaMeasurementModeFlag_ = b;
}

void spadis::Options::setDeltaMeasurementMode(bool b)
{
	deltaMeasurementModeFlag_ = b;
}
